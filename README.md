...
- **Web app**: a hosted page at https://sidekick.workers.dev draws the same sections and checkboxes as the in-game window, for every character logged in on this PC.
